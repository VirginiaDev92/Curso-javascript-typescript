                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializedLocations = locations_1.map(function (location) {
                            return __assign(__assign({}, location), { image_url: env_1["default"].host + ":" + env_1["default"].port + "/uploads/" + location.image });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedLocation = __assign(__assign({}, location), { image_url: env_1["default"].host + ":" + env_1["default"].port + "/uploads/" + location.image });
